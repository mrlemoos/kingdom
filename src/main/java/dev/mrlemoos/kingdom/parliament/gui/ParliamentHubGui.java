...
public final class ParliamentHubGui implements InventoryHolder {
    ...
    static void populate(Inventory inventory, ParliamentHubView view) {
        ...
        placeIfVisible(inventory, view, ParliamentHubAction.TABLE_WAR, SLOT_TABLE_WAR,
    ...
    private static String formatBillState(dev.mrlemoos.kingdom.model.parliament.BillState billState) {
