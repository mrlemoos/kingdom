...
**Pending trial**:
The state between arrest and verdict. A player judge, trial jury, or realm-handled villager judge must adjudicate before a sentence takes effect.
...
_Avoid_: Peer court, mob vote, public poll, jury sentencing panel, hung jury softlock, lectern-gated jury seating, chamber-required jury vote, live jury tally, mid-window juror replacement, jury roll-call, judge seizure of a live jury
